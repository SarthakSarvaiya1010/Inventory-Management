...
function InvoiceEdit() {
  ...
  if (product.length) {
    ...
    testData[0].productlistdata.forEach((sum) => {
      console.log("testData[0].productlistdata", sum);
      totalAmount += sum.amount;
      totalweight += sum.weight;
      totalrate += sum.rate;
    });
  ...
  console.log("InvoicePageData", testData);

  return (
    <div>
      {testData[0]?.productlistdata ? (
        <Container>
